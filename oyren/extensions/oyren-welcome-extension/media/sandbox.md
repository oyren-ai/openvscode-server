...
Nothing here is shared with anyone else, and stopping the session destroys the machine. Anything
worth keeping should be **committed and pushed** — the agent does this as it works, and you can too.
